defmodule PtcManagerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: PtcManagerWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PtcManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PtcManagerWeb.Gettext, "errors", msg, opts)
    end
  end
